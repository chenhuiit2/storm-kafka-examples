 ...
 */
public class RollingTopMerchants {

  private static final Logger LOG = Logger.getLogger(RollingTopMerchants.class);
  ...
  public RollingTopMerchants(String topologyName) throws InterruptedException {
  ...
  public static void main(String[] args) throws Exception {
    ...
    RollingTopMerchants rtw = new RollingTopMerchants(topologyName);
    if (runLocally) {
